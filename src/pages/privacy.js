...
const PrivacyPage = () => (
  <main id="main-content">
    ...
    <div className="main-text">
      ...
      <p>
        {`It explains how we comply with the GDPR (General Data Protection
        Regulation), the DPA (Data Protection Act) [pre GDPR enforcement] and
        the PECR (Privacy and Electronic Communications Regulations).`}
      </p>
      ...
      <p>
      {`Additionally it will explain the use of cookies or software, advertising
      or commercial sponsorship from third parties and the download of any
      documents, files or software made available to you (if any) on this
      website. Further explanations may be provided for specific pages or
      features of this website in order to help you understand how we, this
      website and its third parties (if any) interact with you and your
      computer / device in order to serve it to you. Our contact information
      ...
      <ul>
        ...
        <li>
          ...
          usagedata helps us improve the website structure, design, content and
          functions.`}
        </li>

        <li>
          {`Identify whether you are signed in to our website. A cookie allow us
          to check whether you are signed in to the site.`}
        </li>

        <li>
          {`Test content on our website. For example, 50% of our might see one
      ...
      <p>
        ...
        block all cookies from this website and its external serving vendors or
        use the cookie control system if available upon their first visit.`}
      </p>

      <p>
        {`please note that doing this may affect how our website functions. Some
        pages and services may become unavailable to you.`}
      </p>

      <p>
        {`We will never lease, distribute or sell your personal information unless
        we have your permission or the law requires us to. Any personal
        information we hold about you is stored and processed under our data
      ...
      <p>
        ...
        virus software or similar applications.`}
      </p>
      ...
      <p>
        ...
        any external web links mentioned throughout this website. (External
        links are clickable text / banner / image links to other websites,
        similar to; Church Cottage, Llawhaden or www.celticinst.com.)`}
      </p>

      <p>
        {`Always be wary when submitting data to websites. Read the site’s data
      ...
      <p>
        ...
        social media profile feed or page. You can find further information
        about some social media privacy and usage policies in the resources
        section below.`}
      </p>
      <br />
